[题目链接](https://codeforces.com/gym/104095/problem/K)

# 题意

给你一个字符串，问你是否能只翻转一个区间，让字符串回文
...
我们考虑头尾相同的字符对于结果无影响，所以先把这些字符去掉，然后看这个新字符串是否是PSS,SSP,SPS，P是回文串，S是任意串，符合就是yes，否则就是no
